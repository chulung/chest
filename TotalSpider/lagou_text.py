...
class LagouSpider():
    ...
    def login(self):
        ...
        self.driver.find_element_by_css_selector(".form_body .input[type='text']").send_keys("850004903@qq.com")
        self.driver.find_element_by_css_selector(".form_body input[type='password']").send_keys("wen6650286")
